...
<body>
    ...
    <section id="about">
        <h2>Обо мне</h2>
        <p>Я веб-разработчик с опытом работы в создании современных и адаптивных веб-сайтове.</p>
    </section>
    ...
    <section id="projects">
        ...
        <div class="project">
            ...
            <a href="#">https://github.com/asetupo/bot-pet</a>
        </div>
    </section>
